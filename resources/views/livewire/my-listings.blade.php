                ...
                @foreach($idlePigeons as $pigeon)
                    <div class="bg-aviary-oak/40 border border-aviary-brass/10 rounded-2xl p-5 flex justify-between items-center group hover:border-aviary-blue/30 transition-all shadow-lg relative overflow-hidden galvanized-border">
                        ...
                        <div class="relative z-10">
                            ...
                            <p class="text-[9px] font-black text-aviary-feather/40 uppercase tracking-[0.2em] mt-1 italic">LV.{{ $pigeon->level }} • {{ $pigeon->type }} Strain</p>
                        </div>
                        <div class="flex gap-6 items-center relative z-10">
                            <div class="text-right">
                                <span class="block text-[8px] font-black text-aviary-feather/40 uppercase tracking-widest italic">Base Value</span>
                                <span class="text-sm font-industrial font-black text-aviary-brass italic">{{ number_format($pigeon->fixed_price) }}💰</span>
                            </div>
