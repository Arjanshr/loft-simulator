...
<div class="flex flex-col h-full bg-[#050a0a]/80 backdrop-blur-2xl font-sans" wire:poll.60s="refreshResources">
    <!-- Brand Logo -->
    <div class="h-16 flex items-center px-8 border-b border-white/5 bg-black/40">
    ...
    <nav class="flex-1 px-4 py-8 space-y-2 overflow-y-auto custom-scrollbar">
        ...
        <x-v2-nav-link :href="route('strays')" icon="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" :active="request()->routeIs('strays')" 
                       class="{{ $hasStrays ? 'bg-[#b8860b]/10 border-[#b8860b]/30 text-[#b8860b]' : 'opacity-50 hover:opacity-100' }}">
            {{ $hasStrays ? 'Stray Detected!' : 'Bird Watching' }}
        </x-v2-nav-link>
    ...
    <div class="p-6 border-t border-white/5 bg-black/40">
        <button wire:click="logout" class="w-full flex items-center gap-4 px-6 py-4 rounded-2xl text-red-500/70 hover:bg-red-800/10 hover:text-red-500 transition-all group border border-transparent hover:border-red-500/20 shadow-lg italic">
            ...
            <span class="font-black text-[10px] uppercase tracking-[0.2em]">Exit Loft</span>
        </button>
    </div>
</div>
